...
def test_claim_defaulted_reverts_if_loan_invalid(p2p_usdc_weth, ongoing_loan_usdc_weth):
...
def test_claim_defaulted_reverts_if_loan_not_defaulted(p2p_usdc_weth, ongoing_loan_usdc_weth, now):
...
def test_claim_defaulted_reverts_if_not_lender(p2p_usdc_weth, ongoing_loan_usdc_weth, now, p2p_erc20_proxy):
    time_to_default = ongoing_loan_usdc_weth.maturity - now
    boa.env.time_travel(seconds=time_to_default + 1)

    with boa.reverts("not lender"):
        p2p_usdc_weth.claim_defaulted_loan_collateral(ongoing_loan_usdc_weth, sender=ongoing_loan_usdc_weth.borrower)

    p2p_usdc_weth.set_proxy_authorization(p2p_erc20_proxy, True, sender=p2p_usdc_weth.owner())
    with boa.reverts("not lender"):
        p2p_erc20_proxy.claim_defaulted_loan_collateral(ongoing_loan_usdc_weth, sender=ongoing_loan_usdc_weth.borrower)


def test_claim_defaulted_reverts_with_unauth_proxy(p2p_usdc_weth, ongoing_loan_usdc_weth, now, usdc, p2p_erc20_proxy):
    time_to_default = ongoing_loan_usdc_weth.maturity - now
    boa.env.time_travel(seconds=time_to_default + 1)

    with boa.reverts("not lender"):
        p2p_erc20_proxy.claim_defaulted_loan_collateral(ongoing_loan_usdc_weth, sender=ongoing_loan_usdc_weth.lender)


def test_claim_defaulted(p2p_usdc_weth, ongoing_loan_usdc_weth, now, usdc):
    time_to_default = ongoing_loan_usdc_weth.maturity - now
...
def test_claim_defaulted_works_with_proxy(p2p_usdc_weth, ongoing_loan_usdc_weth, now, usdc, p2p_erc20_proxy):
    p2p_usdc_weth.set_proxy_authorization(p2p_erc20_proxy, True, sender=p2p_usdc_weth.owner())
...
def test_claim_defaulted_logs_event(p2p_usdc_weth, ongoing_loan_usdc_weth, now, usdc):
    time_to_default = ongoing_loan_usdc_weth.maturity - now
...
def test_claim_defaulted_transfers_collateral_to_lender(p2p_usdc_weth, ongoing_loan_usdc_weth, now, usdc, weth):
    time_to_default = ongoing_loan_usdc_weth.maturity - now
