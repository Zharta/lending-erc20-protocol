...
# NOTE: create_leveraged_loan / start_loan / cancel_pending_loan / cancel_redeem are now implemented
# and covered by their own tests — no placeholder loan-facet functions remain.
