...
@pytest.fixture(scope="session")
def p2p_lending_multivault_erc20_contract_def(boa_env):
...
@pytest.fixture(scope="session")
def multivault_mock_contract_def(boa_env):
    return boa.load_partial("contracts/auxiliary/MultiVaultMock.vy")


@pytest.fixture
def securitize_vault_impl(multivault_mock_contract_def):
    """Vault implementation used by the lending contract (4-arg buy/redeem interface)."""
    return multivault_mock_contract_def.deploy()
