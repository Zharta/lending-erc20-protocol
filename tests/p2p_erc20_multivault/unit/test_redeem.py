...
def test_redeem_reverts_if_redemption_addr_not_set(p2p_usdc_weth, ongoing_loan_usdc_weth):
    # Set redemption addr to zero address
    p2p_usdc_weth.set_redemption_addr(ZERO_ADDRESS, sender=p2p_usdc_weth.owner())
