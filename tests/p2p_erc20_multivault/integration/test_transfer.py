...
def test_transfer_loan_non_redeemed(
    ...
    # new_borrower is a key-controlled account so it can both be registered as a Securitize investor
    # and authorize the connector to register the vault created on transfer.
