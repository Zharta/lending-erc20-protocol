...
def test_partially_liquidate_loan_transfers_collateral(p2p_usdc_weth, ongoing_loan_usdc_weth, weth, oracle, usdc, now):
    ...
    borrower_collateral_before = weth.balanceOf(p2p_usdc_weth)
    ...
    assert weth.balanceOf(p2p_usdc_weth) == borrower_collateral_before - collateral_claimed - liquidation_fee
