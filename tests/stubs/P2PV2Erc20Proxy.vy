...
def create_loan(
    ...
    return extcall P2PLendingV2Erc20(self.p2p_lending_erc20).create_loan(offer, principal, collateral_amount, borrower_kyc, lender_kyc)
...
def replace_loan(
    ...
    return extcall P2PLendingV2Erc20(self.p2p_lending_erc20).replace_loan(loan, offer, principal, collateral_amount, lender_kyc)

@external
def settle_loan(loan: base.Loan):
    extcall P2PLendingV2Erc20(self.p2p_lending_erc20).settle_loan(loan)

@external
def revoke_offer(offer: base.SignedOffer):
    extcall P2PLendingV2Erc20(self.p2p_lending_erc20).revoke_offer(offer)

@external
def partially_liquidate_loan(loan: base.Loan):
    extcall P2PLendingV2Erc20(self.p2p_lending_erc20).partially_liquidate_loan(loan)


@external
def liquidate_loan(loan: base.Loan):
    extcall P2PLendingV2Erc20(self.p2p_lending_erc20).liquidate_loan(loan)


@external
def call_loan(loan: base.Loan):
    extcall P2PLendingV2Erc20(self.p2p_lending_erc20).call_loan(loan)


@external
def add_collateral_to_loan(loan: base.Loan, collateral_amount: uint256):
    extcall P2PLendingV2Erc20(self.p2p_lending_erc20).add_collateral_to_loan(loan, collateral_amount)


@external
def remove_collateral_from_loan(loan: base.Loan, collateral_amount: uint256):
    extcall P2PLendingV2Erc20(self.p2p_lending_erc20).remove_collateral_from_loan(loan, collateral_amount)
