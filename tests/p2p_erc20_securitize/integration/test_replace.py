...
def test_replace_loan(
    ...
    if new_collateral_amount > loan.collateral_amount:
        ...
        weth.approve(vault_addr, new_collateral_amount - loan.collateral_amount, sender=loan.borrower)
    ...
    assert weth.balanceOf(vault_addr) == initial_protocol_collateral + new_collateral_amount - loan.collateral_amount
