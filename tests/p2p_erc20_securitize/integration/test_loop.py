"""
Integration tests for Securitize with ACRED token (real forked chain tests).
These tests use the actual ACRED token and Securitize registry on mainnet fork.
"""
