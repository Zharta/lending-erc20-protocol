...
def test_settle_loan_works_on_undercollateralized_loans(
    ...
    # settle the undercollateralized loan
    interest = loan.amount * loan.apr * (now - loan.accrual_start_time) // (86400 * BPS)
    amount_to_settle = loan.amount + interest
