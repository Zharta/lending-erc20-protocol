...
def test_replace_loan(
    ...
    new_loan_id = p2p_usdc_weth.replace_loan_lender(loan, offer_usdc_weth2, offer.principal, kyc_lender2, sender=loan.lender)
    ...
    # new loan hash verification (collateral stays the same for replace_lender)
    new_loan = Loan(
        id=new_loan_id,
