...
def partially_liquidate_loan(
    ...
    base._send_collateral(liquidator, collateral_claimed + liquidation_fee, collateral_token)
...
def liquidate_loan(
    ...
    if remaining_collateral_value >= outstanding_debt:
        ...
        base._send_collateral(liquidator, collateral_for_debt + liquidation_fee_collateral, collateral_token)
        if remaining_collateral > collateral_for_debt:
            base._send_collateral(loan.borrower, remaining_collateral - collateral_for_debt, collateral_token)
        ...
        base._send_collateral(liquidator, loan.collateral_amount, collateral_token)
