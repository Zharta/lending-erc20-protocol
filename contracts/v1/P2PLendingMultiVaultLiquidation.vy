...
"""
@title P2PLendingMultiVaultLiquidation
...
VERSION: public(constant(String[30])) = "P2PLendingMVLiq.20260310"
...
def transfer_loan(
    ...
    new_vault: base.Vault = base._create_new_vault(new_borrower, vault_impl_addr, collateral_token, vault_registrar)
